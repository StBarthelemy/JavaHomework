...
public class Computer1 {
    ...
    private Set<Computer2> notebooks = new HashSet<>();
    private List<Criterion> criterionList = new ArrayList<>();
    private static Scanner scanner = new Scanner(System.in);

    public void printList(){
        for (Computer2 notebook : notebooks){
    ...
    public boolean notebookIsCorrect(Computer2 notebook){
    ...
    public Computer1(Set<Computer2> notebooks) {
        this.scanner = new Scanner(System.in);
        this.notebooks = notebooks;
    }

    public Computer1(Set<Computer2> notebooks, List<Criterion> criterionList) {
        this.scanner = new Scanner(System.in);
        this.notebooks = notebooks;
